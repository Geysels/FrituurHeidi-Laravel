<aside>
    <div class="hidden w-64 border-r bg-white px-4 py-8 dark:border-gray-600 dark:bg-gray-800 md:flex md:flex-col">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Frituur Heidi</h2>
